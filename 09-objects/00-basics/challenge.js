...
module.exports.addProperty = function (object, newProp, newValue){
  if(!object[newProp]){  //If 'not' object named newProp
    object[newProp] = newValue; //then add newProp with a value of newValue to object
  } else { // otherwise
    return object;  //return the `object` argument.
...
/*  var letter = {
  ...
  */
//  var letter = [recipient, msg, sender];

  return "Hello " + letter.recipient + ",\n\n" + letter.msg + "\n\n" + "Sincerely," + "\n" + letter.sender;    
//  return "Hello " + recipient + ",\n\n" + msg + "\n\n" + "Sincerely," + "\n" + sender;
//  return "Hello " + letterRecipient + ",\n\n" + letterMsg + "\n\n" + "Sincerely," + "\n" + letterSender;
};
...
module.exports.canIGet = function (item, money){
  ...
  var canBuy = (products[item] <= money);
